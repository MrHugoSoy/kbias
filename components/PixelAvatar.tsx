  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" width="100%" height="100%" shapeRendering="crispEdges">
        {/* El personaje se dibuja a escala 0.75 hacia el centro: a tamaño
            completo, las orejas "floppy"/"round" y las esquinas del cuerpo
            caían fuera del círculo inscrito en este cuadro de 100x100 y el
            marco circular (rounded-full arriba) las recortaba de forma
            visible. Reducirlo así dentro del propio SVG deja aire alrededor
            en vez de cambiar el diseño de cada animalito uno por uno. */}
